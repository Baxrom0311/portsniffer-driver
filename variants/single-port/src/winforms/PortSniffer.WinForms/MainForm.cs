...
namespace PortSniffer.WinForms
{
    public partial class MainForm : Form
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (!TryGetSelectedPort(out port))
            {
            ...
            arguments = BuildMonitorArguments(port, types, txtApi.Text.Trim());
        ...
        private bool TryGetSelectedPort(out string port)
        {
            port = cmbPort.SelectedItem as string;
        ...
        private static string BuildMonitorArguments(string port, string types, string url)
        {
